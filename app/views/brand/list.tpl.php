    ...
    <tbody>
        ...
        <?php foreach($brand as $brand): ?>
            ...
            <tr>
                ...
                <td><?= $brand->getName() ?></td>
                <td class="text-right">
                    <a href="<?= $router->generate("brand-update", ["id" => $brand->getId()]) ?>" class="btn btn-sm btn-warning">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="<?= $router->generate('brand-list') ?>" data-toggle="dropdown">Oups !</a>
                        </div>
                    </div>
                </td>
            </tr>
